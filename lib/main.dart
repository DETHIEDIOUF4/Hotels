          ...
          child :Column( 
            ...
            children: [ 
              Text("Choose  date " , style : GoogleFonts.nunito( 
                ...
                Text("1 Jan - 22 Jan ",style : GoogleFonts.nunito( 
                color:Colors.black,
                fontSize:17
              ))
            ],
      ...
      children: [ 
        Container( 
          ...
          child: Row(  
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children :[ 
              Text("550 hotels founds " ,style : GoogleFonts.nunito( 
                color:Colors.grey,
                fontSize:15
              )),
                 SizedBox(height:50),
              Row(children :[ 
                Text("Filters " ,style : GoogleFonts.nunito( 
                color:Colors.grey,
                fontSize:15
              )), 
              IconButton( 
